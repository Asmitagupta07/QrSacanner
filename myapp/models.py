...
class UserRegistration(models.Model):
    ...
    amount_allotment = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    amount_expended = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    balance_allotment = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    ...
    disallowed_amount = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
